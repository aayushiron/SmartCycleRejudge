        ...
        btn.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
            for (int i = 0; i < concepts.size(); i++) {
              if (concepts.get(i).name().equals("plastic") || concepts.get(i).name().equals("bottle") || concepts.get(i).name().equals("paper") || concepts.get(i).name().equals("recycling")) {
